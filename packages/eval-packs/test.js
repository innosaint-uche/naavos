...
const sample = {
  ...
  identity: { name: "Test" },
  communication: { tone: "Direct", structure: "Bulleted", verbosity: "Minimal", prohibited_patterns: ["As an AI...", "I'd be happy to..."] },
  operating_rules: [{ id: "evidence.no_false_completion", statement: "Never claim completion without observed validation evidence.", priority: 80 }],
  privacy: { consents: { "allow-cloud-sync": false, "allow-telemetry": false } },
  adapters: [{ host_id: "claude-code", min_adapter_version: "1.0.0" }, { host_id: "gemini", min_adapter_version: "1.0.0" }],
