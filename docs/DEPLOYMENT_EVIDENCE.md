...
- Central packaged no-code QA: PASS — the real Tauri macOS bundle launched with isolated temporary state; Playwright
  ...
  `/Users/radossagency/.radoss-qa/artifacts/naavos-central-release-marker-2026-09-08/universal-tauri-macos/evidence.json`.
- Central all-adapter QA: PASS — `local-agents`, `naas-public` and `universal-tauri-macos` all passed in the same run;
  aggregate evidence is under `/Users/radossagency/.radoss-qa/artifacts/naavos-central-release-marker-2026-09-08/`.
- Central local-agent QA: PASS — Codex, Antigravity and Hermes adapter markers were present; `radoss doctor` confirmed
  ...
  `/Users/radossagency/.radoss-qa/artifacts/naavos-central-release-marker-2026-09-08/local-agents/`.
...
- Current central QA run: `naavos-central-release-marker-2026-09-08` passed the local-agent, public-route, and packaged macOS
  ...
  is under `/Users/radossagency/.radoss-qa/artifacts/naavos-central-release-marker-2026-09-08/`. The NAAvOS CLI rollback
