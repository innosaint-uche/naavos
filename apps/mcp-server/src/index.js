...
export default {
  async fetch(request, env, ctx) {
    ...
    const corsHeaders = {
      ...
      'Access-Control-Allow-Headers': 'Content-Type, X-NAAVOS-User-ID, Authorization'
    };
...
async function handleLoad(request, env, headers) {
  const userId = request.headers.get('X-NAAVOS-User-ID') || 'demo';
