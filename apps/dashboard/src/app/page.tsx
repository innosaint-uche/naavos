      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="hero-title flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
            <a
              href="https://github.com/innosaint-uche/radoss-universal-avatar/tree/main/desktop-setup"
          ...
          <div className="hero-title max-w-2xl mx-auto mt-6 rounded-xl border border-emerald-500/20 bg-emerald-500/5 px-4 py-3 text-left text-sm text-zinc-300">
            ...
            or Ollama. Signed installers and hosted-provider integrations are being certified
            separately.
          </div>
        </div>
