        ...
        <div className="max-w-5xl mx-auto text-center">
          <div className="hero-badge inline-flex items-center gap-2 px-4 py-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 mb-8">
            ...
            <span className="text-sm text-emerald-400 font-medium">
              Open-source MVP — local desktop and CLI available
            </span>
          </div>
          ...
          <div className="hero-title flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
            <a
              href="https://github.com/innosaint-uche/radoss-universal-avatar/releases/tag/v0.2.0-beta.1"
            ...
            <a
              href="https://github.com/innosaint-uche/radoss-universal-avatar/blob/main/desktop-setup/README.md"
          ...
          <div className="hero-title max-w-2xl mx-auto mt-6 rounded-xl border border-emerald-500/20 bg-emerald-500/5 px-4 py-3 text-left text-sm text-zinc-300">
            <span className="font-medium text-emerald-300">For independent users:</span> run the
            local desktop Avatar without NAAvOS hosting, Cloudflare, Coolify, VPS access, Node.js,
            or Ollama. The beta installers are unsigned, so your operating system may show a
            security warning. Signed installers and hosted-provider integrations are being certified
            separately.
          </div>
        </div>
      ...
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-zinc-400 text-base sm:text-lg mb-8 sm:mb-10">
            NAAvOS is an MIT-licensed public development release. Independent users can download the
